...
const isDescribeEach = node => node.callee.type === _experimentalUtils.AST_NODE_TYPES.MemberExpression && node.callee.property.type === _experimentalUtils.AST_NODE_TYPES.Identifier && node.callee.property.name === 'each';
  ...
  create(context) {
    return {
      CallExpression(node) {
        ...
        if ((0, _tsUtils.isFunction)(callbackFunction)) {
